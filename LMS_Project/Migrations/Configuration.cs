namespace LMS_Project.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            // Create a temp user //
            var TmpUser = new ApplicationUser() { UserName = "test@test.com", Email = "test@test.com", PhoneNumber = "0701234567", Firstname = "Test", Lastname = "User", ProfileImage = null, SSN = "185201052663" };
